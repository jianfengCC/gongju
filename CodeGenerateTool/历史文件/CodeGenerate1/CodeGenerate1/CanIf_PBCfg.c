...
const CanIf_RxPduConfigType HrhRxPdu_CanIfHrhCfg[] = {
  ...
  /* 8 */
   {
       .CanIfCanRxPduId            = PDUR_PDU_ID_VCU_vehicle_INFO_CANIF,
       .CanIfCanRxPduLowerCanId    = 0x311,
       .CanIfCanRxPduUpperCanId    = 0x311,
       .CanIfCanRxPduDlc           = 8,
#if ( CANIF_PUBLIC_READRXPDU_DATA_API == STD_ON )
       .CanIfReadRxPduData         = FALSE,
#endif
...
const CanIf_TxBufferConfigType CanIfBufferCfgData[] = {
    ...
    },
    {
        .CanIfBufferSize = 1,
        .CanIfBufferHthRef = &CanIfHthConfigData_CanIfInitHohCfg[0],
        .CanIf_As_BufferId = 55
    },
    {
        .CanIfBufferSize = 1,
        .CanIfBufferHthRef = &CanIfHthConfigData_CanIfInitHohCfg[0],
        .CanIf_As_BufferId = 56
    },
    {
        .CanIfBufferSize = 1,
        .CanIfBufferHthRef = &CanIfHthConfigData_CanIfInitHohCfg[0],
        .CanIf_As_BufferId = 57
    },
    {
        .CanIfBufferSize = 1,
        .CanIfBufferHthRef = &CanIfHthConfigData_CanIfInitHohCfg[0],
        .CanIf_As_BufferId = 58
    },
    {
        .CanIfBufferSize = 1,
        .CanIfBufferHthRef = &CanIfHthConfigData_CanIfInitHohCfg[0],
        .CanIf_As_BufferId = 59
    },
    {
        .CanIfBufferSize = 1,
        .CanIfBufferHthRef = &CanIfHthConfigData_CanIfInitHohCfg[0],
        .CanIf_As_BufferId = 60
    },
};
...
const CanIf_TxPduConfigType CanIfTxPduConfigData[] = {
    ...
    /* 9 */
 {
    ...
    /* 10 */
 {
     .CanIfTxPduId               = PDUR_PDU_ID_IVI_APASet_066_INFO_CANIF,
     .CanIfCanTxPduIdCanId       = 0x066,
     .CanIfCanTxPduIdDlc         = 8,
     .CanIfCanTxPduType          = CANIF_PDU_TYPE_STATIC,
     .CanIfTxPduPnFilterEnable   = STD_OFF,
#if ( CANIF_PUBLIC_READTXPDU_NOTIFY_STATUS_API == STD_ON )
    ...
    /* 11 */
 {
     .CanIfTxPduId               = PDUR_PDU_ID_IVI_ACCSet_067_INFO_CANIF,
     .CanIfCanTxPduIdCanId       = 0x067,
     .CanIfCanTxPduIdDlc         = 8,
     .CanIfCanTxPduType          = CANIF_PDU_TYPE_STATIC,
     .CanIfTxPduPnFilterEnable   = STD_OFF,
#if ( CANIF_PUBLIC_READTXPDU_NOTIFY_STATUS_API == STD_ON )
    ...
    /* 12 */
 {
     .CanIfTxPduId               = PDUR_PDU_ID_IVI_ACCSet_069_INFO_CANIF,
     .CanIfCanTxPduIdCanId       = 0x069,
     .CanIfCanTxPduIdDlc         = 8,
     .CanIfCanTxPduType          = CANIF_PDU_TYPE_STATIC,
     .CanIfTxPduPnFilterEnable   = STD_OFF,
#if ( CANIF_PUBLIC_READTXPDU_NOTIFY_STATUS_API == STD_ON )
    ...
    /* 13 */
 {
     .CanIfTxPduId               = PDUR_PDU_ID_IVI_AVMSet_068_INFO_CANIF,
     .CanIfCanTxPduIdCanId       = 0x068,
     .CanIfCanTxPduIdDlc         = 8,
     .CanIfCanTxPduType          = CANIF_PDU_TYPE_STATIC,
     .CanIfTxPduPnFilterEnable   = STD_OFF,
#if ( CANIF_PUBLIC_READTXPDU_NOTIFY_STATUS_API == STD_ON )
    ...
    /* 14 */
 {
     .CanIfTxPduId               = PDUR_PDU_ID_IVI_APASet_06A_INFO_CANIF,
     .CanIfCanTxPduIdCanId       = 0x06A,
     .CanIfCanTxPduIdDlc         = 8,
     .CanIfCanTxPduType          = CANIF_PDU_TYPE_STATIC,
     .CanIfTxPduPnFilterEnable   = STD_OFF,
#if ( CANIF_PUBLIC_READTXPDU_NOTIFY_STATUS_API == STD_ON )
    ...
    /* 15 */
 {
     .CanIfTxPduId               = PDUR_PDU_ID_IVI_APASet_06B_INFO_CANIF,
     .CanIfCanTxPduIdCanId       = 0x06B,
     .CanIfCanTxPduIdDlc         = 8,
     .CanIfCanTxPduType          = CANIF_PDU_TYPE_STATIC,
     .CanIfTxPduPnFilterEnable   = STD_OFF,
#if ( CANIF_PUBLIC_READTXPDU_NOTIFY_STATUS_API == STD_ON )
    ...
    /* 55 */
 {
     ...
     .CanIfTxPduIdCanIdType      = CANIF_CAN_ID_TYPE_11,
        .CanIfUserTxConfirmation    = PDUR_CALLOUT,
        .CanIfTxPduBufferRef        = &CanIfBufferCfgData[55],
#if ( CANIF_OSEKNM_SUPPORT == STD_ON )
        .OsekNmTxConfirmationSupport = STD_OFF,
#endif
    },
    /* 56 */
 {
     ...
     .CanIfTxPduIdCanIdType      = CANIF_CAN_ID_TYPE_11,
        .CanIfUserTxConfirmation    = PDUR_CALLOUT,
        .CanIfTxPduBufferRef        = &CanIfBufferCfgData[56],
#if ( CANIF_OSEKNM_SUPPORT == STD_ON )
        .OsekNmTxConfirmationSupport = STD_OFF,
#endif
    },
    /* 57 */
 {
     ...
     .CanIfTxPduIdCanIdType      = CANIF_CAN_ID_TYPE_11,
        .CanIfUserTxConfirmation    = PDUR_CALLOUT,
        .CanIfTxPduBufferRef        = &CanIfBufferCfgData[57],
#if ( CANIF_OSEKNM_SUPPORT == STD_ON )
        .OsekNmTxConfirmationSupport = STD_OFF,
#endif
    },
    /* 58 */
 {
     ...
     .CanIfTxPduIdCanIdType      = CANIF_CAN_ID_TYPE_11,
        .CanIfUserTxConfirmation    = PDUR_CALLOUT,
        .CanIfTxPduBufferRef        = &CanIfBufferCfgData[58],
#if ( CANIF_OSEKNM_SUPPORT == STD_ON )
        .OsekNmTxConfirmationSupport = STD_OFF,
#endif
    },
    /* 59 */
 {
     .CanIfTxPduId               = PDUR_PDU_ID_SWHC_400_INFO_CANIF,
     .CanIfCanTxPduIdCanId       = 0x400,
     .CanIfCanTxPduIdDlc         = 8,
     .CanIfCanTxPduType          = CANIF_PDU_TYPE_STATIC,
     .CanIfTxPduPnFilterEnable   = STD_OFF,
#if ( CANIF_PUBLIC_READTXPDU_NOTIFY_STATUS_API == STD_ON )
     ...
     .CanIfTxPduIdCanIdType      = CANIF_CAN_ID_TYPE_11,
        .CanIfUserTxConfirmation    = PDUR_CALLOUT,
        .CanIfTxPduBufferRef        = &CanIfBufferCfgData[59],
#if ( CANIF_OSEKNM_SUPPORT == STD_ON )
        .OsekNmTxConfirmationSupport = STD_OFF,
#endif
    },
    /* 60 */
 {
     ...
     .CanIfTxPduIdCanIdType      = CANIF_CAN_ID_TYPE_11,
        ...
        .CanIfTxPduBufferRef        = &CanIfBufferCfgData[60],
#if ( CANIF_OSEKNM_SUPPORT == STD_ON )
        .OsekNmTxConfirmationSupport = STD_OFF,
#endif
    },
...
const CanIf_TxBufferConfigType *const CanIfCtrlCfg_BufferList[] = {
    ...
    &CanIfBufferCfgData[55],
    &CanIfBufferCfgData[56],
    &CanIfBufferCfgData[57],
    &CanIfBufferCfgData[58],
    &CanIfBufferCfgData[59],
    &CanIfBufferCfgData[60],
};
