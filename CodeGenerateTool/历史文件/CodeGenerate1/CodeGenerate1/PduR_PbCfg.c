...
const PduRDestPdu_type PduRDestination_VCU_vehicle_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x311_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
...
const PduRDestPdu_type PduRDestination_ADS_RPA_3AC_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x3AC_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_ADS_RPA_3A8_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x3A8_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
...
const PduRDestPdu_type PduRDestination_ADS_TDU_STATE_345_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x345_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_ADS_WarningSt_2AA_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x2AA_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_ADS_WarningSt_2AB_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x2AB_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_ADS_RadarWarningSt_2AD_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x2AD_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_ADS_RadarWarningSt_2AF_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x2AF_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_ADS_RadarWarningSt_2B2_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x2B2_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_ADS_FunctionSt_2B3_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x2B3_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_ADS_FunctionSt_2B5_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x2B5_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_ADS_FunctionSt_2B6_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x2B6_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_ADS_FunctionSt_2B7_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x2B7_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
...
const PduRDestPdu_type PduRDestination_ADS_APAState_30D_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x30D_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_ADS_ACCState_30E_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x30E_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_ADS_FunctionSt_308_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x308_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_ADS_FunctionSt_307_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x307_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_ADS_FunctionSt_31B_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x31B_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_ADS_FunctionSt_321_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x321_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
...
const PduRDestPdu_type PduRDestination_TBOX_413_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x413_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
...
const PduRDestPdu_type PduRDestination_IVI_APASet_066_INFO_Tx_PduRDestPdu = {
    .DestModule     = AS_PDUR_CANIF,
    .DestPduId      = CANIF_PDU_ID_0x066_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_IVI_ACCSet_067_INFO_Tx_PduRDestPdu = {
    .DestModule     = AS_PDUR_CANIF,
    .DestPduId      = CANIF_PDU_ID_0x067_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_IVI_ACCSet_069_INFO_Tx_PduRDestPdu = {
    .DestModule     = AS_PDUR_CANIF,
    .DestPduId      = CANIF_PDU_ID_0x069_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_IVI_AVMSet_068_INFO_Tx_PduRDestPdu = {
    .DestModule     = AS_PDUR_CANIF,
    .DestPduId      = CANIF_PDU_ID_0x068_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_IVI_APASet_06A_INFO_Tx_PduRDestPdu = {
    .DestModule     = AS_PDUR_CANIF,
    .DestPduId      = CANIF_PDU_ID_0x06A_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_IVI_APASet_06B_INFO_Tx_PduRDestPdu = {
    .DestModule     = AS_PDUR_CANIF,
    .DestPduId      = CANIF_PDU_ID_0x06B_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
...
const PduRDestPdu_type PduRDestination_VSP_state_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x3A0_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
...
const PduRDestPdu_type PduRDestination_PDC_state_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x3B7_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_PDC_state1_3B8_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x3B8_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
};
const PduRDestPdu_type PduRDestination_PDC_state1_3B9_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x3B9_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
...
const PduRDestPdu_type PduRDestination_HOD_21C_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x21C_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
...
const PduRDestPdu_type PduRDestination_TBOX_timeAndGPS_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
...
const PduRDestPdu_type PduRDestination_GW_IF_OBD_state_INFO_Rx_PduRDestPdu = {
    .DestModule     = AS_PDUR_COM,
    .DestPduId      = ComConf_ComIPdu_0x515_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
...
const PduRDestPdu_type PduRDestination_SWHC_400_INFO_Tx_PduRDestPdu = {
    .DestModule     = AS_PDUR_CANIF,
    .DestPduId      = CANIF_PDU_ID_0x400_INFO,
    .NofGroupRefs = 0,
    .RoutingPathGroupRefs = NULL,
    .DataProvision  = PDUR_NO_PROVISION,
    .TxBufferId     =  PDUR_NO_BUFFER
...
const PduRDestPdu_type * const PduRDestinations_VCU_vehicle_INFO_Rx[] = {
    &PduRDestination_VCU_vehicle_INFO_Rx_PduRDestPdu,
    NULL
};
...
const PduRDestPdu_type * const PduRDestinations_ADS_RPA_3AC_INFO_Rx[] = {
    &PduRDestination_ADS_RPA_3AC_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_ADS_RPA_3A8_INFO_Rx[] = {
    &PduRDestination_ADS_RPA_3A8_INFO_Rx_PduRDestPdu,
    NULL
};
...
const PduRDestPdu_type * const PduRDestinations_ADS_TDU_STATE_345_INFO_Rx[] = {
    &PduRDestination_ADS_TDU_STATE_345_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_ADS_WarningSt_2AA_INFO_Rx[] = {
    &PduRDestination_ADS_WarningSt_2AA_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_ADS_WarningSt_2AB_INFO_Rx[] = {
    &PduRDestination_ADS_WarningSt_2AB_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_ADS_RadarWarningSt_2AD_INFO_Rx[] = {
    &PduRDestination_ADS_RadarWarningSt_2AD_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_ADS_RadarWarningSt_2AF_INFO_Rx[] = {
    &PduRDestination_ADS_RadarWarningSt_2AF_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_ADS_RadarWarningSt_2B2_INFO_Rx[] = {
    &PduRDestination_ADS_RadarWarningSt_2B2_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_ADS_FunctionSt_2B3_INFO_Rx[] = {
    &PduRDestination_ADS_FunctionSt_2B3_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_ADS_FunctionSt_2B5_INFO_Rx[] = {
    &PduRDestination_ADS_FunctionSt_2B5_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_ADS_FunctionSt_2B6_INFO_Rx[] = {
    &PduRDestination_ADS_FunctionSt_2B6_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_ADS_FunctionSt_2B7_INFO_Rx[] = {
    &PduRDestination_ADS_FunctionSt_2B7_INFO_Rx_PduRDestPdu,
    NULL
};
...
const PduRDestPdu_type * const PduRDestinations_ADS_APAState_30D_INFO_Rx[] = {
    &PduRDestination_ADS_APAState_30D_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_ADS_ACCState_30E_INFO_Rx[] = {
    &PduRDestination_ADS_ACCState_30E_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_ADS_FunctionSt_308_INFO_Rx[] = {
    &PduRDestination_ADS_FunctionSt_308_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_ADS_FunctionSt_307_INFO_Rx[] = {
    &PduRDestination_ADS_FunctionSt_307_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_ADS_FunctionSt_31B_INFO_Rx[] = {
    &PduRDestination_ADS_FunctionSt_31B_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_ADS_FunctionSt_321_INFO_Rx[] = {
    &PduRDestination_ADS_FunctionSt_321_INFO_Rx_PduRDestPdu,
    NULL
};
...
const PduRDestPdu_type * const PduRDestinations_TBOX_413_INFO_Rx[] = {
    &PduRDestination_TBOX_413_INFO_Rx_PduRDestPdu,
    NULL
};
...
const PduRDestPdu_type * const PduRDestinations_IVI_APASet_066_INFO_Tx[] = {
    &PduRDestination_IVI_APASet_066_INFO_Tx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_IVI_ACCSet_067_INFO_Tx[] = {
    &PduRDestination_IVI_ACCSet_067_INFO_Tx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_IVI_ACCSet_069_INFO_Tx[] = {
    &PduRDestination_IVI_ACCSet_069_INFO_Tx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_IVI_AVMSet_068_INFO_Tx[] = {
    &PduRDestination_IVI_AVMSet_068_INFO_Tx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_IVI_APASet_06A_INFO_Tx[] = {
    &PduRDestination_IVI_APASet_06A_INFO_Tx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_IVI_APASet_06B_INFO_Tx[] = {
    &PduRDestination_IVI_APASet_06B_INFO_Tx_PduRDestPdu,
    NULL
};
...
const PduRDestPdu_type * const PduRDestinations_VSP_state_INFO_Rx[] = {
    &PduRDestination_VSP_state_INFO_Rx_PduRDestPdu,
    NULL
};
...
const PduRDestPdu_type * const PduRDestinations_PDC_state_INFO_Rx[] = {
    &PduRDestination_PDC_state_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_PDC_state1_3B8_INFO_Rx[] = {
    &PduRDestination_PDC_state1_3B8_INFO_Rx_PduRDestPdu,
    NULL
};
const PduRDestPdu_type * const PduRDestinations_PDC_state1_3B9_INFO_Rx[] = {
    &PduRDestination_PDC_state1_3B9_INFO_Rx_PduRDestPdu,
    NULL
};
...
const PduRDestPdu_type * const PduRDestinations_HOD_21C_INFO_Rx[] = {
...
const PduRDestPdu_type * const PduRDestinations_TBOX_timeAndGPS_INFO_Rx[] = {
    &PduRDestination_TBOX_timeAndGPS_INFO_Rx_PduRDestPdu,
    NULL
};
...
const PduRDestPdu_type * const PduRDestinations_GW_IF_OBD_state_INFO_Rx[] = {
    &PduRDestination_GW_IF_OBD_state_INFO_Rx_PduRDestPdu,
    NULL
};
...
const PduRDestPdu_type * const PduRDestinations_SWHC_400_INFO_Tx[] = {
    &PduRDestination_SWHC_400_INFO_Tx_PduRDestPdu,
    NULL
};
...
const PduRRoutingPath_type PduRRoutingPath_VCU_vehicle_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x311_INFO,
    .PduRDestPdus = PduRDestinations_VCU_vehicle_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
...
const PduRRoutingPath_type PduRRoutingPath_ADS_RPA_3AC_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x3AC_INFO,
    .PduRDestPdus = PduRDestinations_ADS_RPA_3AC_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_ADS_RPA_3A8_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x3A8_INFO,
    .PduRDestPdus = PduRDestinations_ADS_RPA_3A8_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
...
const PduRRoutingPath_type PduRRoutingPath_ADS_TDU_STATE_345_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x345_INFO,
    .PduRDestPdus = PduRDestinations_ADS_TDU_STATE_345_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_ADS_WarningSt_2AA_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x2AA_INFO,
    .PduRDestPdus = PduRDestinations_ADS_WarningSt_2AA_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_ADS_WarningSt_2AB_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x2AB_INFO,
    .PduRDestPdus = PduRDestinations_ADS_WarningSt_2AB_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_ADS_RadarWarningSt_2AD_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x2AD_INFO,
    .PduRDestPdus = PduRDestinations_ADS_RadarWarningSt_2AD_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_ADS_RadarWarningSt_2AF_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x2AF_INFO,
    .PduRDestPdus = PduRDestinations_ADS_RadarWarningSt_2AF_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_ADS_RadarWarningSt_2B2_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x2B2_INFO,
    .PduRDestPdus = PduRDestinations_ADS_RadarWarningSt_2B2_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_ADS_FunctionSt_2B3_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x2B3_INFO,
    .PduRDestPdus = PduRDestinations_ADS_FunctionSt_2B3_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_ADS_FunctionSt_2B5_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x2B5_INFO,
    .PduRDestPdus = PduRDestinations_ADS_FunctionSt_2B5_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_ADS_FunctionSt_2B6_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x2B6_INFO,
    .PduRDestPdus = PduRDestinations_ADS_FunctionSt_2B6_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_ADS_FunctionSt_2B7_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x2B7_INFO,
    .PduRDestPdus = PduRDestinations_ADS_FunctionSt_2B7_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_ADS_HMI_2C6_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
...
const PduRRoutingPath_type PduRRoutingPath_ADS_APAState_30D_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x30D_INFO,
    .PduRDestPdus = PduRDestinations_ADS_APAState_30D_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_ADS_ACCState_30E_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x30E_INFO,
    .PduRDestPdus = PduRDestinations_ADS_ACCState_30E_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_ADS_FunctionSt_308_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x308_INFO,
    .PduRDestPdus = PduRDestinations_ADS_FunctionSt_308_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_ADS_FunctionSt_307_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x307_INFO,
    .PduRDestPdus = PduRDestinations_ADS_FunctionSt_307_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_ADS_FunctionSt_31B_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x31B_INFO,
    .PduRDestPdus = PduRDestinations_ADS_FunctionSt_31B_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_ADS_FunctionSt_321_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x321_INFO,
    .PduRDestPdus = PduRDestinations_ADS_FunctionSt_321_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
...
const PduRRoutingPath_type PduRRoutingPath_TBOX_413_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x413_INFO,
    .PduRDestPdus = PduRDestinations_TBOX_413_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
...
const PduRRoutingPath_type PduRRoutingPath_IVI_APASet_066_INFO_Tx = {
    .SrcModule     = AS_PDUR_COM,
    .SrcPduId = ComConf_ComIPdu_0x066_INFO,
    .PduRDestPdus = PduRDestinations_IVI_APASet_066_INFO_Tx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_IVI_ACCSet_067_INFO_Tx = {
    .SrcModule     = AS_PDUR_COM,
    .SrcPduId = ComConf_ComIPdu_0x067_INFO,
    .PduRDestPdus = PduRDestinations_IVI_ACCSet_067_INFO_Tx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_IVI_ACCSet_069_INFO_Tx = {
    .SrcModule     = AS_PDUR_COM,
    .SrcPduId = ComConf_ComIPdu_0x069_INFO,
    .PduRDestPdus = PduRDestinations_IVI_ACCSet_069_INFO_Tx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_IVI_AVMSet_068_INFO_Tx = {
    .SrcModule     = AS_PDUR_COM,
    .SrcPduId = ComConf_ComIPdu_0x068_INFO,
    .PduRDestPdus = PduRDestinations_IVI_AVMSet_068_INFO_Tx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_IVI_APASet_06A_INFO_Tx = {
    .SrcModule     = AS_PDUR_COM,
    .SrcPduId = ComConf_ComIPdu_0x06A_INFO,
    .PduRDestPdus = PduRDestinations_IVI_APASet_06A_INFO_Tx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_IVI_APASet_06B_INFO_Tx = {
    .SrcModule     = AS_PDUR_COM,
    .SrcPduId = ComConf_ComIPdu_0x06B_INFO,
    .PduRDestPdus = PduRDestinations_IVI_APASet_06B_INFO_Tx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
...
const PduRRoutingPath_type PduRRoutingPath_VSP_state_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x3A0_INFO,
    .PduRDestPdus = PduRDestinations_VSP_state_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
...
const PduRRoutingPath_type PduRRoutingPath_PDC_state_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x3B7_INFO,
    .PduRDestPdus = PduRDestinations_PDC_state_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_PDC_state1_3B8_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x3B8_INFO,
    .PduRDestPdus = PduRDestinations_PDC_state1_3B8_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
const PduRRoutingPath_type PduRRoutingPath_PDC_state1_3B9_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x3B9_INFO,
    .PduRDestPdus = PduRDestinations_PDC_state1_3B9_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
...
const PduRRoutingPath_type PduRRoutingPath_HOD_21C_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x21C_INFO,
    .PduRDestPdus = PduRDestinations_HOD_21C_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
...
const PduRRoutingPath_type PduRRoutingPath_TBOX_timeAndGPS_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x4F5_INFO,
    .PduRDestPdus = PduRDestinations_TBOX_timeAndGPS_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
...
const PduRRoutingPath_type PduRRoutingPath_GW_IF_OBD_state_INFO_Rx = {
    .SrcModule     = AS_PDUR_CANIF,
    .SrcPduId = CANIF_PDU_ID_0x515_INFO,
    .PduRDestPdus = PduRDestinations_GW_IF_OBD_state_INFO_Rx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
...
const PduRRoutingPath_type PduRRoutingPath_SWHC_400_INFO_Tx = {
    .SrcModule     = AS_PDUR_COM,
    .SrcPduId = ComConf_ComIPdu_0x400_INFO,
    .PduRDestPdus = PduRDestinations_SWHC_400_INFO_Tx,
    .PduRDirectGateway = TRUE,
    .PduRTpThreshld = 0,
};
...
const PduRRoutingPath_type * const PduRRoutingPaths[] = {
    ...
    &PduRRoutingPath_VCU_vehicle_INFO_Rx,
    ...
    &PduRRoutingPath_ADS_RPA_3AC_INFO_Rx,
    &PduRRoutingPath_ADS_RPA_3A8_INFO_Rx,
    &PduRRoutingPath_ABM_state_INFO_Rx,
    &PduRRoutingPath_APA_35B_INFO_Rx,
    &PduRRoutingPath_ADS_TDU_STATE_345_INFO_Rx,
    &PduRRoutingPath_ADS_WarningSt_2AA_INFO_Rx,
    &PduRRoutingPath_ADS_WarningSt_2AB_INFO_Rx,
    &PduRRoutingPath_ADS_RadarWarningSt_2AD_INFO_Rx,
    &PduRRoutingPath_ADS_RadarWarningSt_2AF_INFO_Rx,
    &PduRRoutingPath_ADS_RadarWarningSt_2B2_INFO_Rx,
    &PduRRoutingPath_ADS_FunctionSt_2B3_INFO_Rx,
    &PduRRoutingPath_ADS_FunctionSt_2B5_INFO_Rx,
    ...
    &PduRRoutingPath_ADS_FunctionSt_307_INFO_Rx,
    &PduRRoutingPath_ADS_FunctionSt_31B_INFO_Rx,
    &PduRRoutingPath_ADS_FunctionSt_321_INFO_Rx,
    &PduRRoutingPath_VCU_state2_INFO_Rx,
    &PduRRoutingPath_TBOX_413_INFO_Rx,
    ...
    &PduRRoutingPath_VSP_state_INFO_Rx,
    ...
    &PduRRoutingPath_PDC_state_INFO_Rx,
    &PduRRoutingPath_PDC_state1_3B8_INFO_Rx,
    &PduRRoutingPath_PDC_state1_3B9_INFO_Rx,
    ...
    &PduRRoutingPath_IVI_APASet_066_INFO_Tx,
    &PduRRoutingPath_IVI_ACCSet_067_INFO_Tx,
    &PduRRoutingPath_IVI_ACCSet_069_INFO_Tx,
    &PduRRoutingPath_IVI_AVMSet_068_INFO_Tx,
    &PduRRoutingPath_IVI_APASet_06A_INFO_Tx,
    &PduRRoutingPath_IVI_APASet_06B_INFO_Tx,
    ...
    &PduRRoutingPath_SWHC_400_INFO_Tx,
    NULL
};
