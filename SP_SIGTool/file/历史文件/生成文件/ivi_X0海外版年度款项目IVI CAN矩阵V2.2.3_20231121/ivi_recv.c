...
void setSignal_VSP_state(uint8_t *sigbuff, uint8_t len);
    ...
    while(startpos + 3 < msg.len) {
        ...
        if (IVI_SIG_PUB == type) {
            ...
            case 0x0C5:
                ...
                break;
            case 0x3A0:
                setSignal_VSP_state(sigbuff, len - 1);
                break;
            case 0x0C6:
...
void setSignal_IVI_dvrSet(uint8_t *sigbuff, uint8_t len)
{
    ...
    bResult |= Rte_Write_rpSR_CANMSG_IVI_dvrSet_ComIn_VeCAN_IVI_PRE_Key(&p_IVI_dvrSet_st.IVI_PRE_Key);
    bResult |= Rte_Write_rpSR_CANMSG_IVI_dvrSet_ComIn_VeCAN_IVI_NEXT_Key(&p_IVI_dvrSet_st.IVI_NEXT_Key);
    bResult |= Rte_Write_rpSR_CANMSG_IVI_dvrSet_ComIn_VeCAN_IVI_Play_Key(&p_IVI_dvrSet_st.IVI_Play_Key);
    bResult |= Rte_Write_rpSR_CANMSG_IVI_dvrSet_ComIn_VeCAN_IVI_Lock_Key(&p_IVI_dvrSet_st.IVI_Lock_Key);
    bResult |= Rte_Write_rpSR_CANMSG_IVI_dvrSet_ComIn_VeCAN_IVI_Delete_Request(&p_IVI_dvrSet_st.IVI_Delete_Request);
    bResult |= Rte_Write_rpSR_CANMSG_IVI_dvrSet_ComIn_VeCAN_IVI_AVREnableSet(&p_IVI_dvrSet_st.IVI_AVREnableSet);
    bResult |= Rte_Write_rpSR_CANMSG_IVI_dvrSet_ComIn_VeCAN_IVI_AVRTapeSet(&p_IVI_dvrSet_st.IVI_AVRTapeSet);
    bResult |= Rte_Write_rpSR_CANMSG_IVI_dvrSet_ComIn_VeCAN_IVI_AVREmergencyRecSet(&p_IVI_dvrSet_st.IVI_AVREmergencyRecSet);
    bResult |= Rte_Write_rpSR_CANMSG_IVI_dvrSet_ComIn_VeCAN_IVI_AVRPhotoReq(&p_IVI_dvrSet_st.IVI_AVRPhotoReq);
    bResult |= Rte_Write_rpSR_CANMSG_IVI_dvrSet_ComIn_VeCAN_IVI_FormatSDReq(&p_IVI_dvrSet_st.IVI_FormatSDReq);
    bResult |= Rte_Write_rpSR_CANMSG_IVI_dvrSet_ComIn_VeCAN_IVI_AVRRecCycleSet(&p_IVI_dvrSet_st.IVI_AVRRecCycleSet);
    bResult |= Rte_Write_rpSR_CANMSG_IVI_dvrSet_ComIn_VeCAN_IVI_SetReplayDirectory(&p_IVI_dvrSet_st.IVI_SetReplayDirectory);
    bResult |= Rte_Write_rpSR_CANMSG_IVI_dvrSet_ComIn_VeCAN_ivi_VehicleInfoRecordSet(&p_IVI_dvrSet_st.ivi_VehicleInfoRecordSet);
    bResult |= Rte_Write_rpSR_CANMSG_IVI_dvrSet_ComIn_VeCAN_ivi_FactorySettingReq(&p_IVI_dvrSet_st.ivi_FactorySettingReq);
...
{
    uint8_t bResult = RTE_SIG_OK;
    if (p_VSP_state_st.data_len - 1 != len) {
        SystemApiLogPrintf(LOG_ERROR_OUTPUT,"sig len error:%d\r\n", len);
        return;
    }
    memcpy(((uint8_t*)&p_VSP_state_st) + 4, sigbuff, len);

    bResult |= Rte_Write_rpSR_CANMSG_VSP_state_ComIn_VeCAN_vsp_errorStatus(&p_VSP_state_st.vsp_errorStatus);
    bResult |= Rte_Write_rpSR_CANMSG_VSP_state_ComIn_VeCAN_vsp_soundEnable(&p_VSP_state_st.vsp_soundEnable);
    bResult |= Rte_Write_rpSR_CANMSG_VSP_state_ComIn_VeCAN_vsp_errorIdentification(&p_VSP_state_st.vsp_errorIdentification);
    bResult |= Rte_Write_rpSR_CANMSG_VSP_state_ComIn_VeCAN_vsp_SoundOnOffSts(&p_VSP_state_st.vsp_SoundOnOffSts);
    bResult |= Rte_Write_rpSR_CANMSG_VSP_state_ComIn_VeCAN_vsp_SoundConfigure(&p_VSP_state_st.vsp_SoundConfigure);
    bResult |= Rte_Write_rpSR_CANMSG_VSP_state_ComIn_VeCAN_VSP_unlocksoundSetFb(&p_VSP_state_st.VSP_unlocksoundSetFb);
    bResult |= Rte_Write_rpSR_CANMSG_VSP_state_ComIn_VeCAN_VSP_lockSoundSetFb(&p_VSP_state_st.VSP_lockSoundSetFb);

    if (bResult != RTE_SIG_OK) {
        SystemApiLogPrintf(LOG_ERROR_OUTPUT,"setSignal_VSP_state error bResult:0x%x\r\n", bResult);
    }
}
...
void setSignal_IC_RequestAndStatus(uint8_t *sigbuff, uint8_t len)
{
    ...
    bResult |= Rte_Write_rpSR_CANMSG_IC_RequestAndStatus_ComIn_VeCAN_IC_DisFail(&p_IC_RequestAndStatus_st.IC_DisFail);
