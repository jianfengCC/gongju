...
}p_TBOX_infoCtrl_st = {0x00, 0xA8, 6};
...
struct package_0x223_st_GTW_esc_eps_iB_info
{
    ...
    uint8_t esc_hhcAvailable;
}p_GTW_esc_eps_iB_info_st = {0x02, 0x23, 24};
...
}p_AVM_state_484_st = {0x04, 0x84, 10};
...
}p_MFW_KeySt_st = {0x04, 0x98, 8};

struct package_0x4F5_st_IVI_timeAndGPS
{
    uint8_t canid_high;
    uint8_t canid_low;
    uint8_t data_len;
    ...
    uint8_t IVI_timeValid;
    uint8_t IVI_longitude_H;
    uint8_t IVI_longitude_L;
    uint8_t IVI_latitude_H;
    uint8_t IVI_latitude_L;
}p_IVI_timeAndGPS_st = {0x04, 0xF5, 12};
