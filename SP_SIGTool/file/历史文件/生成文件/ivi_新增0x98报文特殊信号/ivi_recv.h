...
struct package_0x096_st_IVI_096
{
    ...
    uint8_t ivi_FrontDefrostLevelSet;
}p_IVI_096_st = {0x00, 0x96, 11};
...
struct package_0x066_st_IVI_APASet_066
{
    uint8_t canid_high;
    uint8_t canid_low;
    uint8_t data_len;
    uint8_t data_status;
    uint8_t IVI_APAFuncSet;
    uint8_t IVI_RPAFuncSet;
    uint8_t IVI_APADrvSpeedSet;
    uint8_t IVI_AVMViewSet;
    uint8_t IVI_AVMCarBodyTranspSet;
    uint8_t IVI_AVMtrigByTurnningSet;
    uint8_t IVI_AVMTrajectoryDisplaySet;
    uint8_t IVI_AVMtrigBySensorSet;
    uint8_t IVI_PDCSoundSet;
    uint8_t IVI_PDCMuteReq;
    uint8_t IVI_laeb_SW;
    uint8_t IVI_FrontPDCAlarmSet;
    uint8_t IVI_APAParkInTypeSel;
    uint8_t IVI_ParkSceneReconSw;
}p_IVI_APASet_066_st = {0x00, 0x66, 15};

struct package_0x067_st_IVI_ACCSet_067
{
    uint8_t canid_high;
    uint8_t canid_low;
    uint8_t data_len;
    uint8_t data_status;
    uint8_t IVI_ICAOnOffSet;
    uint8_t IVI_lanechangestaly;
    uint8_t ivi_autolanechangeSet;
    uint8_t ivi_RampfollowcarSet;
    uint8_t IVI_NCAOnOffSet;
    uint8_t IVI_SpeedlimitSet;
    uint8_t IVI_voicebroadcastSet;
    uint8_t IVI_ParkPosn1_ID_H;
    uint8_t IVI_ParkPosn1_ID_L;
    uint8_t IVI_SpeedProportionSet;
    uint8_t IVI_SpeedValueSet;
    uint8_t IVI_LanechangStyleSet;
    uint8_t IVI_TargetSpeedOffsetSet;
    uint8_t IVI_TargetSpeedOffsetValueSet;
    uint8_t IVI_NCAFuncSet;
    uint8_t IVI_ICAFuncSet;
    uint8_t IVI_ALCFuncSet;
    uint8_t IVI_LaneChangeConfirmSet;
}p_IVI_ACCSet_067_st = {0x00, 0x67, 19};

struct package_0x069_st_IVI_ACCSet_069
{
    uint8_t canid_high;
    uint8_t canid_low;
    uint8_t data_len;
    uint8_t data_status;
    uint8_t IVI_SLAFuncSet;
    uint8_t IVI_SlaOffsetAdjusttSet;
    uint8_t IVI_SlaValueAdjustSet;
    uint8_t IVI_TrafficLightRemFuncSet;
    uint8_t IVI_LaneAssistTypeSet;
    uint8_t IVI_LasWarnModeSet;
    uint8_t IVI_ELKFuncSet;
    uint8_t IVI_FcwFuncSet;
    uint8_t IVI_AEBFuncSet;
    uint8_t IVI_LaebFuncSet;
    uint8_t IVI_RCWFuncSet;
    uint8_t IVI_BsdLcaFuncSet;
    uint8_t IVI_DowFuncSet;
...
struct package_0x068_st_IVI_AVMSet_068
{
    ...
    uint8_t data_len;
    uint8_t data_status;
    uint8_t IVI_AVMRotationAngle_X_H;
    uint8_t IVI_AVMRotationAngle_X_L;
    uint8_t IVI_AVMRotationAngle_Y;
    uint8_t IVI_APACustomizeSlot;
    uint8_t IVI_RpaApaSwitch;
    uint8_t IVI_APAFuncReq;
    uint8_t IVI_ParkDirSel;
    uint8_t IVI_AVMViewSelect;
    uint8_t IVI_ParkSpcGrdLockCfim;
}p_IVI_AVMSet_068_st = {0x00, 0x68, 10};

struct package_0x06A_st_IVI_APASet_06A
{
    uint8_t canid_high;
    uint8_t canid_low;
    uint8_t data_len;
    uint8_t data_status;
    uint8_t IVI_APAChosedSlotID_H;
    uint8_t IVI_APAChosedSlotID_MH;
    uint8_t IVI_APAChosedSlotID_ML;
    uint8_t IVI_APAChosedSlotID_L;
}p_IVI_APASet_06A_st = {0x00, 0x6A, 5};

struct package_0x06B_st_IVI_APASet_06B
{
    uint8_t canid_high;
    uint8_t canid_low;
    uint8_t data_len;
    uint8_t data_status;
    uint8_t IVI_APACustomizedSlotCPoint_x_H;
    uint8_t IVI_APACustomizedSlotCPoint_x_L;
    uint8_t IVI_APACustomizedSlotCPoint_y_H;
    uint8_t IVI_APACustomizedSlotCPoint_y_L;
    uint8_t IVI_APACustomizedSlotAngle_H;
    uint8_t IVI_APACustomizedSlotAngle_L;
}p_IVI_APASet_06B_st = {0x00, 0x6B, 7};
...
struct package_0x496_st_IVI_hmi
{
    ...
    uint8_t IVI_AdsWarnLvl;
    uint8_t IVI_UserID;
    uint8_t ivi_CampModeReq;
}p_IVI_hmi_st = {0x04, 0x96, 9};
...
}p_IC_RequestAndStatus_st = {0x04, 0xA2, 7};
