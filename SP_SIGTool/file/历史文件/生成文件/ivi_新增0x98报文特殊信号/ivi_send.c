...
BOOL getSignal_TBOX_infoCtrl(void)
{
    ...
    Read_Signal = 0;
    bResult = Rte_Read_rpSR_CANMSG_TBOX_infoCtrl_ComIn_VeCAN_TBOX_WaccEaultEliminate(&Read_Signal);
    if (bResult == RTE_SIG_OK) {
        p_TBOX_infoCtrl_st.TBOX_WaccEaultEliminate = Read_Signal;
    } else {
        p_TBOX_infoCtrl_st.TBOX_WaccEaultEliminate = 0;
    }
